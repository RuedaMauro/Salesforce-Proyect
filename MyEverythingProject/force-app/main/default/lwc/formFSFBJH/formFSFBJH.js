 ...
 **/
 ...
 //APEX CONTROLLERS
 import solicitarPresupuesto from '@salesforce/apex/AccountCreationJHController.solicitarPresupuesto';
 import solicitarPresupuestoWithoutAcc from '@salesforce/apex/AccountCreationJHController.solicitarPresupuestoWithoutAcc';
 import checkExistingSolicitante from '@salesforce/apex/AccountCreationJHController.checkExistingSolicitante';
 import getDataLookup from '@salesforce/apex/AccountCreationJHController.getDataLookup'; 
 import uploadFile from '@salesforce/apex/AccountCreationJHController.uploadFile';
 //IMAGES
...
export default class FormFSFBJH extends LightningElement {
    @api recordId;
    @api cedNum;
    @api cedProfesional;
    @api itemsSelected = [];
    ...
    handleCedProfesional(event) {
        this.cedProfesional = event.target.value;
        if (event.detail.value === '') {
            alert("Ingrese un número de cédula porfavor");
        }
    }
